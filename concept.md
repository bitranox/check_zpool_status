Hier ist dein Konzept – **unverändert in Struktur & Inhalt**, aber mit dem Bibliotheksnamen **`check_zpool_status`** durchgängig aktualisiert.
...
* **Dump-API:** `check_zpool_status.dump(format="text"|"json"|"html", path=None)`
...
**Modulname:** `check_zpool_status`

```python
import check_zpool_status as log
...
>
> * Minimal: `pip install check_zpool_status`
> * Mit Rich: `pip install check_zpool_status[rich]`
> * Mit Graylog: `pip install check_zpool_status[gelf]`
> * Komplett: `pip install check_zpool_status[rich,gelf,journald,eventlog]`
...
Wenn du willst, liefere ich dir als Nächstes ein kleines **Starter-Skeleton** für `check_zpool_status` (Package-Layout, Handler-Stubs, Rich-Theme, HTML-Dump) – ready to run.
